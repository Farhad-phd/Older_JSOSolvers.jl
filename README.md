...
- `iR2N`: an inexact second-order quadratic regularization method for unconstrained optimization with shifted L-BFGS systems;
...
stats = lbfgs(nlp) # or trunk, tron, R2, iR2, iR2N
```
